    ...
    <el-card>
      ...
      <el-table :data="goodslist" border stripe>
        ...
        <el-table-column label="操作" width="130px">
          <template slot-scope="scope">
            <el-button type="primary" icon="el-icon-edit" size="mini" @click="show1(scope.row.goods_id)"></el-button>
    ...
    editFormRules:{
              goods_name :[
               { required: true, message: '请输入商品名称', trigger: 'blur' },
                { min: 2, max: 100, message: '请输入的长度在 2 到 100个字符', trigger: 'blur' }
       ],
        //  goods_price: [
        //     { required: true, message: '请输入商品价格', trigger:'blur' },
        //     { min: 0, max: 5, message: '请输入的长度在 0 到 5 个字符', trigger: 'blur' }
        //   ],
        //  goods_number: [
        ...
        //     { min: 0, max: 3, message: '请输入的长度在 0 到 3 个字符', trigger: 'blur' }
        //   ]
          }
    }
  },
